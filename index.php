...
<div class="about-section">
    ...
    <p class="about-description">
        Somos una empresa global, enfocada en la investigación y el desarrollo, manufactura y comercialización de una amplia gama de medicamentos y servicios veterinarios. Ofrecemos uno de los portafolios de productos más innovadores de la industria, incluyendo productos para la prevención, tratamiento y control de enfermedades para la mayoría de las especies de producción y de compañía.
    </p>
</div>
...
<div class="trust-section"> 
    ...
    <div class="new-images">
        ...
        <div class="bottom-row">
            ...
            <div class="image-container">
                <img src="Views/Images/imgIndex/new5.png" alt="Nueva Imagen 5" class="new-image">
                <a href="#" class="image-button button5">Odontología veterinaria</a>
            </div>
            <div class="image-container">
                <img src="Views/Images/imgIndex/new6.png" alt="Nueva Imagen 6" class="new-image">
                <a href="#" class="image-button button6">Nutrición veterinaria</a>
            </div>
        </div>
    </div>
</div>
...
<div class="description">
    <p>Nuestro equipo interdisciplinario está equipado para proporcionar tratamientos avanzados,</p>
    <p>basándose en el diagnóstico preciso del veterinario especialista.</p>
</div>
